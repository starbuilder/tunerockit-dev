...
?>
<ul class="menu">
  <li><input id="edit-search-block-form--2" class="form-text" type="search" value="" name="search_block_form" title="Enter the terms you wish to search for."></li>
  <li><button id="edit-submit" class="form-submit button radius" type="submit" name="op">Search</button></li>
